...
async function connectToWA() {
  ...
  console.log("Senu-Md Connecting... ✅");
  ...
  senu.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Senu-Md installed successful ✅");
      console.log("Senu-Md connected to whatsapp ✅");
